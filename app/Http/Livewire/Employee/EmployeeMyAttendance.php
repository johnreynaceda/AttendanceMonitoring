...
class EmployeeMyAttendance extends Component implements Tables\Contracts\HasTable
{
    use Tables\Concerns\InteractsWithTable;
    protected function getTableQuery(): Builder
    {
        return AttendanceMonitoring::query()->where('employee_id', auth()->user()->employee->id)->orderBy('created_at', 'DESC');
    }
    ...
    {
        return view('livewire.employee.employee-my-attendance');
    }
}